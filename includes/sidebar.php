...
<?php endif; ?>
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= BASE_URL ?>/packages.php" class="nav-link <?= $current_page === 'packages.php' ? 'active' : '' ?>">
    ...
    <a href="<?= BASE_URL ?>/dedicated.php" class="nav-link <?= $current_page === 'dedicated.php' ? 'active' : '' ?>">
